...
public class AirportTest {
    ...
    public void shouldReturnTransportMilitaryPlanes() {
        ...
        boolean hasTransportPlane = false;
        for (MilitaryPlane militaryPlane : transportMilitaryPlanes) {
            if ((militaryPlane.getType() == MilitaryType.TRANSPORT)) {
                hasTransportPlane = true;
                break;
            }
        }
        Assert.assertTrue(hasTransportPlane);
    }
    ...
    @Test
    public void shouldReturnPlanesSortedByMaxCapacity() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public void shouldExistAtLeastOneBomberInMilitaryPlanes() {
        Airport airport = new Airport(planes);
    ...
    @Test
    public void shouldReturnExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        Airport airport = new Airport(planes);
