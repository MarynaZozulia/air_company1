...
public class AirportTest {
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        Assert.assertTrue(
                bomberMilitaryPlanes.stream().anyMatch(plane -> plane.getType() == MilitaryType.BOMBER),
                "No BOMBER plane found in military planes."
        );
    }
    ...
    public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified(){
        ...
        Assert.assertTrue(
                ...
                "There are experimental planes with 'UNCLASSIFIED' classification level."
        );
    }
}
