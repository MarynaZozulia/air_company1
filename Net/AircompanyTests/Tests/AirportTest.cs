...
public class AirportTest
{
    ...
    public void MyTest1()
    {
        ...
        foreach (var militaryPlane in transportMilitaryPlanes.Where(militaryPlane => (militaryPlane.PlaneTypeIs() == MilitaryType.TRANSPORT)))
        {
            hasMilitaryTransportPlane = true;
        }
        Assert.That(hasMilitaryTransportPlane, Is.True);
    }
    ...
    public void MyTest3()
    {
        ...
        Assert.That(nextPlaneMaxLoadCapacityIsHigherThanCurrent, Is.EqualTo(true));
    }
}